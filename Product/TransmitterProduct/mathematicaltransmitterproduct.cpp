                                                               ...
                                                               ProductObservable *receiver)
{
    ...
    if (amountSegment == 1) {
        ...
        //       (cos(M_PI/2*cos(thetaI))/sin(thetaI));
        Efield += groundEfield * totaleArrayFactor(angle_prime, thetat);
                                            ...
                                            const float direction)
{
    ...
    m_receiversPowers[receiver].erase(m_receiversPowers[receiver].begin(),
                                      m_receiversPowers[receiver].end());
