                                                               ...
                                                               ProductObservable *receiver, bool properties)
{
    ...
    if (amountSegment == 1) {
        ...
        complex <double> groundEfield = this->computeEfieldGround(receiver,angle_transmitter,properties); // Compute the electrical field from the ray reflected off the ground
        Efield += groundEfield;
    }
    if (properties)
    {
