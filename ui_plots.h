...
public:
    ...
    {
        plots->setWindowTitle(QApplication::translate("plots", "Plot", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_1), QApplication::translate("plots", "Map", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("plots", "Model", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_6), QApplication::translate("plots", "Cell Range", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("plots", "Physical Impulse Response", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("plots", "h_l vs BW", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("plots", "US TDL", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("plots", "Spectrum", 0));
    } // retranslateUi
