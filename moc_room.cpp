...
QT_MOC_LITERAL(1, 5, 18), // "mouseScenePosition"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "QPointF&"
QT_MOC_LITERAL(4, 34, 3), // "pos"
QT_MOC_LITERAL(5, 38, 14) // "displayResults"

    },
    "room\0mouseScenePosition\0\0QPointF&\0pos\0"
    "displayResults"
};
...
void room::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mouseScenePosition((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        ...
        {
            using _t = void (room::*)(QPointF & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&room::mouseScenePosition)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (room::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&room::displayResults)) {
                *result = 1;
                return;
            }
        }
...
void *room::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "AbstractScene"))
        return static_cast< AbstractScene*>(this);
...
// SIGNAL 0
void room::mouseScenePosition(QPointF & _t1)
{
